...
module.exports = {
  insertAppStat: function (appName, actionType, description, ip) {
    ...
    // BUILD SQL
    var insertSql = `INSERT INTO public.tbl_app_stats (app_name,action_type,action_description,action_date) values ($1,$2,$3,$4,$5);`;
  ...
  getAppStats: function(fromDate, toDate, type, callback) {
    ...
    var sql = `select x,y from public.get_app_statsxy($1,$2,$3);`;
